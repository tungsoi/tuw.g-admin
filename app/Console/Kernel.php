...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('sale-revenue-report:update', ['2022-04-01', '2022-04-30'])->dailyAt("13:00");
        $schedule->command('sale-revenue-report:update', ['2022-04-01', '2022-04-30'])->dailyAt("21:00");
        $schedule->command('sale:salary', ['2022-04-01', '2022-04-30'])->hourly();
