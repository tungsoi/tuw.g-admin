...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('sale-revenue-report:update', ['2022-05-01', '2022-05-31'])->dailyAt("13:00");
        $schedule->command('sale-revenue-report:update', ['2022-05-01', '2022-05-31'])->dailyAt("21:00");
        $schedule->command('sale:salary', ['2022-05-01', '2022-05-31'])->hourly();
