...
class WeightPortalCustomerController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lịch sử chia cân cho khách hàng';
...
SCRIPT;
    ...
    protected function grid()
    {
        ...
        $grid->filter(function ($filter) {
            ...
            $filter->equal('user_created_id', 'Nhân viên')->select($user);
        });
