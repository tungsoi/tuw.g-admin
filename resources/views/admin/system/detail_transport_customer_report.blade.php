<table class="table table-bordered">
    <thead>
        ...
        <th style="background-color: wheat !important;">TỔNG ỨNG KÉO (TỆ)</th>
    </thead>
    <tbody>
        <tr>
            <td>
            ...
            <td>{{ number_format($data->sum('kg')) }}</td>
            <td>{{ number_format($data->sum('m3')) }}</td>
            <td>{{ number_format($data->sum('advance_drag')) }}</td>
        </tr>
    </tbody>
</table>